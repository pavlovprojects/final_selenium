...
class LoginPage(BasePage):
    ...
    def register_new_user(self, email, password):
        ...
        self.browser.find_element(*LoginPageLocators.CONFORM_PASSWORD_FOR_REGISTRATION).send_keys(password)
        self.browser.find_element(*LoginPageLocators.REGISTER_SUBBMIT).click()